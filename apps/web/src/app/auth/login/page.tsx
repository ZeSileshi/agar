  ...
  return (
    <div className="min-h-screen bg-navy-950 text-gold-100 flex flex-col">
      ...
      <div className="pointer-events-none fixed inset-0 overflow-hidden">
        <div className="absolute -top-40 -right-40 h-[500px] w-[500px] rounded-full bg-gold-400/5 blur-[120px]" />
        <div className="absolute -bottom-40 -left-40 h-[400px] w-[400px] rounded-full bg-gold-500/3 blur-[100px]" />
      </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-5">
              ...
              <div>
                <div className="flex items-center justify-between mb-2">
                  <label htmlFor="password" className="block text-sm font-medium text-gold-200/60">
                    Password
                  </label>
                  <button
                    type="button"
