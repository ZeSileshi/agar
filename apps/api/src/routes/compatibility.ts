    ...
    if (cached) {
      res.json({
        ...
        data: {
          ...
          disclaimer: 'Compatibility scores are generated by our algorithm and are for entertainment and guidance only. They are not a guarantee of relationship success. Trust your instincts too!',
        },
      });
      return;
    }
